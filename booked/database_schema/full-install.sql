...
USE hostel;
GRANT ALL on hostel.* to 'Marisa'@'localhost' identified by 'Nomnom123';
GRANT ALL on hostel.* to 'Marisa'@'127.0.0.1' identified by 'Nomnom123';SET foreign_key_checks = 0;
