<?php /* Smarty version Smarty-3.1.16, created on 2016-12-17 20:47:03
         compiled from "C:\xampp\htdocs\booked\tpl\Admin\Resources\manage_resources.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2011058559637c02693-36192196%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8588a1b42470cb5e78c05bc5decbdd0f5513b66a' => 
    array (
      0 => 'C:\\xampp\\htdocs\\booked\\tpl\\Admin\\Resources\\manage_resources.tpl',
      1 => 1479140418,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2011058559637c02693-36192196',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58559638221cd2_65007382',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58559638221cd2_65007382')) {function content_58559638221cd2_65007382($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include 'C:\\xampp\\htdocs\\booked\\lib\\Common/../../lib/external/Smarty/plugins\\function.html_options.php';
?>
...
<?php } else { ?>#ffffff<?php }?>' alt="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'ResourceColor'),$_smarty_tpl);?>
"
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['resource']->value->GetName(), ENT_QUOTES, 'UTF-8', true);?>
								...
								<a class="update renameButton" href="#"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'Rename'),$_smarty_tpl);?>
</a> |
								<a class="update deleteButton" href="#"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'Delete'),$_smarty_tpl);?>
</a>
							</div>
							<div>
...
'/>
								<input type='number' size='2' id='minDurationMinutes' class='minutes form-control inline'
									   maxlength='2' title='Minutes' max='99' min='0' placeholder='<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'minutes'),$_smarty_tpl);?>
'/>
...
'/>
								<input type='number' id='startNoticeMinutes' size='2' class='minutes form-control inline'
									   maxlength='2' max='99' min='0' title='Minutes' placeholder='<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'minutes'),$_smarty_tpl);?>
'/>
