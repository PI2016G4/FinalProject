...
$conf['settings']['admin.email'] = 'admin2@example.com';         // email address of admin user
...
$conf['settings']['database']['user'] = 'Marisa';        // database user with permission to the booked database
$conf['settings']['database']['password'] = 'Nomnom123';
$conf['settings']['database']['hostspec'] = '127.0.0.1';        // ip, dns or named pipe
$conf['settings']['database']['name'] = 'hostel';
/**
 ...
 */
$conf['settings']['install.password'] = '5852aba2bc8e4';
/**
 * Pages
 */
